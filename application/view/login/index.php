    ...
    <div class="max-w-md w-full bg-white rounded-lg shadow-sm p-8 space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Not a member yet? 
                <a href="<?php echo Config::get('URL'); ?>register" class="text-indigo-600 hover:text-indigo-500">
                    Register here
                </a>
            </p>
        </div>
        ...
        <form method="post" action="<?php echo Config::get('URL'); ?>login/login" class="mt-8 space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                    <a href="<?php echo Config::get('URL'); ?>login/requestPasswordReset" class="text-indigo-600 hover:text-indigo-500">
                        Forgot password?
                    </a>
                </div>
            </div>
